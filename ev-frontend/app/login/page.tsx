...
export default function LoginPage() {
  ...
  function onUserSubmit(values: z.infer<typeof loginFormSchema>) {
    console.log("User login:", values)
    // In a real app, you would authenticate the user
    router.push("/dashboard")
  }

  function onAdminSubmit(values: z.infer<typeof loginFormSchema>) {
    console.log("Admin login:", values)
    // In a real app, you would authenticate the admin
